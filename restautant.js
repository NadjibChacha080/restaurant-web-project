...
function Affich() {
    ...
    window.confirm(`reserved successfully... the number of reservation:${Math.ceil(parseInt(numPeople)/4) }${date.getDate()+date.getMonth()+date.getTime()}` );
    const msg= `Welcom to tastyfood , 
    your reservation: 
    number of people ${numPeople}
    the date ${dateInput.value}
...
let quntity = document.getElementsByName('quantity');
...
function buy() { 
    ...
    if(r_her.checked ===true){
        r_her.checked =false;
        window.confirm(`reserved successfully... the number of reservation${numreceipt.innerHTML}`);
        const msg1= `Welcom to tastyfood , 
        your reservation: 
        Final price: ${finaleprice.innerHTML}
        the number of reservation: ${numreceipt.innerHTML}`;
        
    }else{
        r_home.checked =false;
        window.confirm(`reserved successfully... 
            the number of reservation${numreceipt.innerHTML}
